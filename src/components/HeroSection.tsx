...
const HeroSection: React.FC = () => {
  const grantWriterUrl = "https://chatgpt.com/g/g-67db608596448191b99ec4ac18d92d3e-grant-writer-gpt";
    ...
    <section className="pt-32 pb-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          {/* 3D Card/Visual - Updated with more meaningful content and made clickable */}
          <div className="w-full lg:w-1/2 flex justify-center">
            ...
            >
              <ThreeDElement className="glass-morphism rounded-xl p-6 w-full hover:shadow-neon-blue cursor-pointer transition-all duration-300">
